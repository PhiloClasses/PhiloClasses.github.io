...
global_variables() {
    ...
    # Blog title
    global_title="PhiloClasses"
    # The typical subtitle for each blog
    global_description="Suppléments au cours de philosophie et HLP."
    # The public base URL for this blog
    global_url="https://PhiloClasses.github.io"
    ...
    global_author_url=""
    # Your email
    global_email="st3ph.martin@laposte.net"
    ...
    template_archive="Voir plus…"
    # "All posts" (title of archive page)
    template_archive_title="Tous les articles"
    # "All tags"
    template_tags_title="Tous les tags"
    # "posts" (on "All tags" page, text at the end of each tag line, like "2. Music - 15 posts")
    template_tags_posts="articles"
    template_tags_posts_2_4="articles"  # Some slavic languages use a different plural form for 2-4 items
    template_tags_posts_singular="article"
    # "Posts tagged" (text on a title of a page with index of one tag, like "My Blog - Posts tagged "Music"")
    template_tag_title="Articles avec tags"
    ...
    template_subscribe="Syndication"
    # "Subscribe to this page..." (used as text for browser feed button that is embedded to html)
    template_subscribe_browser_button="S'abonner à cette page…"
    # "Tweet" (used as twitter text button for posting to twitter)
    template_twitter_button="Tweet"
    template_twitter_comment="&lt;Tapez votre commentaire ici mais laissez l'URL libre pour que les autres followers puissent suivre le commentaire&gt;"
